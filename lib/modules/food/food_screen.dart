  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        _OrderCard(name: 'Le Jardin', items: 'Tagine, Couscous, Mint Tea', time: '2 days ago', status: 'Delivered', accent: accent),
        ...
        _SavedRestaurant(name: 'Dar Zellij', cuisine: 'Moroccan', rating: 4.8, accent: accent),
        _SavedRestaurant(name: 'Café Clock', cuisine: 'Fusion', rating: 4.6, accent: accent),
        _SavedRestaurant(name: 'La Sqala', cuisine: 'Moroccan-French', rating: 4.7, accent: accent),
